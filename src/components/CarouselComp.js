  ...
  return (
    <Carousel className='carousel-container'>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <h3 className='text-white fs-1 fw-bold'>Located at the heart of Navy Yard Washington D.C.</h3>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3  className='text-white fs-1 fw-bold'>We offer modern nail art, colors, and styles.</h3>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p className='fs-5'> Call us at 202-544-2804 to book an appointment for your next manicure, pedicure, or other service! </p>
        </Carousel.Caption>
      </Carousel.Item>
